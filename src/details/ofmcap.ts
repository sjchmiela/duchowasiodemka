export const ofm = {
  ...
  history: [
    "Bezpośrednio po swojej elekcji Jan III Sobieski, w 1674 r., za przykładem Zygmunta II i Władysława IV zwrócił się do papieża Klemensa X z prośbą o udzielenie pozwolenia kapucynom na przybycie do Polski. Do Krakowa, już na stały pobyt, kapucyni przybyli w 1695 r.",
    ...
    "Po zakończeniu budowy kościoła i klasztoru kapucynów z woli fundatora, Wojciecha Dembińskiego powstała kolejna świątynia, tym razem poświęconą Matce Bożej Loretańskiej. Świątynia miała spełniać rolę rodowej kaplicy, a w podziemiach zaplanowano krypty dla zmarłych z rodziny. Loret zlokalizowano pomiędzy klasztorem a pałacykiem fundatora."
  ],
  relics: [
    "Najcenniejsze zabytki to Kabinet Jana III Sobieskiego (sepet) - ozdobny mebel z rzymskiej pracowni Giacomo Hermana podarowany prawdopodobnie przez papieża Innocentego XI królowi Janowi III po bitwie wiedeńskiej w dowód uznania za zasługi dla chrześcijańskiego świata. Ofiarowany kapucynom do kaplicy Domu Loretańskiego przez jego syna Jakuba Sobieskiego od 1733 r. pełni swe sakralne funkcje.",

    "Ostatni obraz namalowany przez Szymona Czechowicza w 1775 r. Dzieło jest przykładem przemiany baroku w klasycyzm, który w tym okresie rodzi się na nowo. Obraz ilustruje podanie związane z odnalezieniem grobu św. Franciszka.",

    "Obraz Jezusa Miłosiernego namalowany przez Alfreda Hyłę. Tło u dołu obrazu przedstawia płonącą Warszawę, obraz bowiem był malowany z końcem 1944 r. jako wotum za ocalenie życia przez wysiedlonych mieszkańców stolicy po Powstaniu Warszawskim, którzy znaleźli schronienie w krakowskim klasztorze kapucynów."
  ],
  facts: [
  ...
  founder: [
    "W 1525 roku Mateusz z Bascio kierowany pragnieniem naśladowania św. Franciszka w jego ubóstwie i wędrownym kaznodziejstwie, przyjmując nowy krój habitu – tunikę ze spiczastym kapturem – uprosił u papieża pozwolenie na nowy sposób życia. Trzy lata później papież Klemens VII bullą Religionis zelus prawnie zatwierdził istnienie nowej wspólnoty braterskiej, która pierwotnie przyjęła nazwę: Zakon Braci Mniejszych Życia Eremickiego, nazywany przez ludzi niedługo potem kapucynami. Dopiero jednak kapituła z 1535/36 r., na której powstały pierwsze konstytucje, nakreśliła istotne elementy charyzmatu kapucynów, który odtąd miał polegać na naśladowaniu Chrystusa na wzór św. Franciszka z Asyżu i wiernym zachowywaniu Reguły i Testamentu. W praktyce utrzymano kontemplacyjny i eremicki wymiar powołania, wzbogacając go o wymiar braterski i apostolski. Reforma kapucyńska miała być niczym innym, jak tylko powrotem do sposobu życia i duchowości św. Franciszka, którego uważano za swego pierwszorzędnego i jedynego założyciela.",
